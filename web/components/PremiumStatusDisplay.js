                ...
                <div className="text-white space-y-3">
                    ...
                    {showDetails && (
                        <>
                            ...
                            {/* Management Button - for monthly subscriptions and lifetime users */}
                            {(planType === 'monthly' || planType === 'lifetime') && (
                                <div className="pt-3">
                                    <button
                                        onClick={async (e) => {
                                            e.stopPropagation();
                                            console.log('🏛️ Opening Stripe Customer Portal...');
                                            await window.premiumService.openCustomerPortal();
                                        }}
                                    ...
                                    >
                                        <div className="flex items-center justify-center space-x-2">
                                            ...
                                            <span>{planType === 'monthly' ? 'Manage Subscription' : 'Manage Billing'}</span>
                                        </div>
                                    </button>
                                </div>
                            )}
